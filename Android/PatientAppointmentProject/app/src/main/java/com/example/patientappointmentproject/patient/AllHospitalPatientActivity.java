...
import com.example.patientappointmentproject.admin.AllHospitalAdminActivity;
...
public class AllHospitalPatientActivity extends AppCompatActivity {
    ...
    Context context = AllHospitalPatientActivity.this;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_all_hospital_patient);
...
//        list_all_department.addItemDecoration(dividerItemDecoration);
        adapter = new AllHospitalAdapter(context,items,false);
